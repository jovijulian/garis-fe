...
import AccommodationCard from '@/components/accommodation/AccommodationCard'; // Pastikan nama import sesuai
...
export default function AccommodationOrders() {
    ...
    const fetchUserOrders = async () => {
        ...
        try {
            ...
            console.error(err);
            setError("Gagal memuat daftar pesanan akomodasi.");
    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
             ...
             <div className="flex justify-end mb-4">
                <button
                    onClick={() => router.push('/orders/create-accommodation')}
            ...
            {orders.length > 0 ? (
                ...
                <div className="text-center py-16 bg-white rounded-xl border border-dashed border-gray-300">
                    ...
                    <h3 className="text-lg font-medium text-gray-700">Belum ada pesanan akomodasi</h3>
                    <p className="text-gray-500 text-sm mt-1">Butuh tempat menginap? Buat pengajuan sekarang.</p>
                </div>
            )}
