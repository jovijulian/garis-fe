        ...
        <Modal isOpen={isOpen} onClose={onClose} className="max-w-md">
            <div className="p-6 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                    Booking untuk keperluan "<strong className="text-gray-800 dark:text-white">{booking.purpose}</strong>" akan dibatalkan. Pengguna akan menerima notifikasi.
                    <br />
                ...
                <div className="flex justify-center gap-4">
                    ...
                    >
                        ...
                        {isSubmitting ? 'Memproses...' : 'Ya, Batalkan Booking'}
                    </button>
                </div>
            </div>
        </Modal>
