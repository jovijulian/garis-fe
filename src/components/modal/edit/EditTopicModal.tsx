...
const EditTopicModal: React.FC<EditProps> = ({
    isOpen,
    selectedId,
    onClose,
    onSuccess,
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            setError("");
            try {
                const response = await httpGet(endpointUrl(`topics/${selectedId}`), true);
                ...
                toast.error(err?.response?.data?.message || "Failed to fetch facility data.");
    ...
    const handleSubmit = async () => {
        ...
        try {
            await httpPut(endpointUrl(`topics/${selectedId}`), payload, true);
            toast.success("Berhasil mengubah topik");
            setName("");
            setDescription("");
            onClose();
            onSuccess?.();
            ...
            setError(error?.response?.data?.message || "Gagal mengubah topik");
        }
