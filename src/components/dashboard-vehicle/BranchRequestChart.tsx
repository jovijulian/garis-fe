...
const BranchRequestChart: React.FC<BranchRequestChartProps> = ({ data }) => {
    ...
    return (
        <ResponsiveContainer width="100%" height={300}>
            <BarChart data={data} margin={{ top: 5, right: 10, left: -20, bottom: 5 }}>
                ...
                <Bar dataKey="request_count" name="Jumlah Pengajuan" fill="#8884d8" barSize={20} />
            </BarChart>
        </ResponsiveContainer>
    );
};
...
export default BranchRequestChart; 