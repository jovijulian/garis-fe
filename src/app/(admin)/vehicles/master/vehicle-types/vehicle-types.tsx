...
import EditModal from "@/components/modal/edit/EditVehicleTypeModal";
    ...
    const getData = async () => {
        ...
        try {
            const response = await httpGet(
                endpointUrl("vehicle-types"), true, params
            );
        ...
        <div className="space-y-4">
            ...
            <div className="flex justify-end items-center">
                <div className="flex gap-2">
                    ...
                    <button
                        onClick={() => router.push("/vehicles/master/vehicle-types/create")}
            ...
            <DeactiveModal
                ...
                url={`vehicle-types/${selectedData?.id}`}
                itemName={selectedData?.name || ""}
                selectedData={selectedData}
                onSuccess={getData}
                message="Jenis Konsumsi berhasil dihapus!"
            />
