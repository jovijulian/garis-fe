...
import EditModal from "@/components/modal/edit/EditDriverModal";
import EditStatusModal from "@/components/modal/edit/EditDriverStatusModal";
    ...
    const columnsNew = useMemo(() => {
        const defaultColumns = [
            ...
            },
            {
                ...
                cell: ({ row }: any) => <span>{row.phone_number}</span>,
            },
            {
                id: "cabang.nama_cab",
                header: "Cabang",
    ...
    const getData = async () => {
        ...
        try {
            const response = await httpGet(
                endpointUrl("drivers"), true, params
            );
        ...
        <div className="space-y-4">
            ...
            <div className="flex justify-end items-center">
                <div className="flex gap-2">
                    ...
                    <button
                        onClick={() => router.push("/vehicles/master/drivers/create")}
