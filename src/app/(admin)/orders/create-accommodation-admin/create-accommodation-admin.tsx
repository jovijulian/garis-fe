...
export default function CreateAccommodationPage() {
    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            try {
                ...
                const usersRes = await httpGet(endpointUrl("/users/options"), true);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.push('/orders/manage-order-accommodation');
        } catch (error: any) {
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <Select options={userOptions} value={_.find(userOptions, { value: headerData.user_id })} onValueChange={(opt) => handleFieldChange('user_id', opt ? opt.value : null)} placeholder="Pilih nama pengguna..." />
                        </div>
                        <div>
