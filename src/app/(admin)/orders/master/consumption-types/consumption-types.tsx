...
import EditModal from "@/components/modal/edit/EditConsumptionTypeModal";
    ...
    const getData = async () => {
        ...
        try {
            const response = await httpGet(
                endpointUrl("consumption-types"), true, params
            );
        ...
        <div className="space-y-4">
            ...
            <div className="flex justify-end items-center">
                <div className="flex gap-2">
                    ...
                    <button
                        onClick={() => router.push("/orders/master/consumption-types/create")}
            ...
            <DeactiveModal
                ...
                url={`consumption-types/${selectedData?.id}`}
                itemName={selectedData?.name || ""}
                selectedData={selectedData}
                onSuccess={getData}
                message="Tipe Konsumsi berhasil dihapus!"
            />
