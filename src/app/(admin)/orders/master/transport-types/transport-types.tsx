...
import EditModal from "@/components/modal/edit/EditTransportTypeModal";
    ...
    const getData = async () => {
        ...
        try {
            const response = await httpGet(
                endpointUrl("transport-types"), true, params
            );
        ...
        <div className="space-y-4">
            ...
            <div className="flex justify-end items-center">
                <div className="flex gap-2">
                    ...
                    <button
                        onClick={() => router.push("/orders/master/transport-types/create")}
            ...
            <DeactiveModal
                ...
                url={`transport-types/${selectedData?.id}`}
                itemName={selectedData?.name || ""}
                selectedData={selectedData}
                onSuccess={getData}
                message="Jenis Transportasi berhasil dihapus!"
            />
