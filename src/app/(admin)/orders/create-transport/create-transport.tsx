...
export default function CreateTransportPage() {
    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            try {
                ...
                const typesRes = await httpGet(endpointUrl("/transport-types/options"), true);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success("Pengajuan transportasi berhasil dikirim!");
    ...
    return (
        <ComponentCard title="Ajukan Pesanan Transportasi">
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            />
                            <p className="text-xs text-gray-400 mt-1">*Bisa diisi jam spesifik atau rentang waktu.</p>
                        </div>
                    </div>
                </div>
