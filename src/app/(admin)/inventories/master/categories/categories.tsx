...
import EditModal from "@/components/modal/edit/EditInventoryCategoryModal";
    ...
    const getData = async () => {
        ...
        try {
            const response = await httpGet(
                endpointUrl("inventory-categories"), true, params
            );
        ...
        <div className="space-y-4">
            ...
            <div className="flex justify-end items-center">
                <div className="flex gap-2">
                    ...
                    <button
                        onClick={() => router.push("/inventories/master/categories/create")}
            ...
            <DeactiveModal
                ...
                url={`inventory-categories/${selectedData?.id}`}
